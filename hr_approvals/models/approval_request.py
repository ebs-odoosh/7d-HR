    ...
    def _get_created_job(self):
        for rec in self:
            if len(rec.related_job) > 0:
                rec.created_job_position = rec.related_job[0]
            else:
                rec.created_job_position = False
...
class Job(models.Model):
    ...
    requisition_job_title = fields.Many2one(related="related_requisition.job_title", string="Requisition Job Title")
